...
[RequireComponent(typeof(Dog_MovementController))]
[RequireComponent(typeof(Animator))]
public class Dog_AnimationController : MonoBehaviour
{
    #region Declares

    Dog_MovementController movement;
    Animator animaton;
    Transform t;
    ...
    void Start()
    {
        ...
        movement = GetComponent<Dog_MovementController>();
