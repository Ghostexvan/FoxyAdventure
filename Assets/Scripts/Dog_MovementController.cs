...
public class Dog_MovementController : MonoBehaviour
{
    #region Declares
    ...
    void DetectMovementRange(){
        triggerLayer = LayerMask.GetMask("Trigger");
        Vector2 direction = isFacingRight ? Vector2.right : Vector2.left;
        RaycastHit2D hit = Physics2D.CircleCast(mainCollider.bounds.center, mainCollider.size.x, direction, 0.8f, triggerLayer);
